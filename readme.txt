...
WordPress plugin for helping you add banners to the left and right side of your WordPress website. Upload the banners to the media library and assign it to the left or right of your website without coding. With this plugin you are able to display one banner or both by using the Turn on/off setting under additional settings section.

By default the banners are 120px but you can set a custom width by entering a value in the Width field. Also whether the banners scroll together with the page content or remains fixed in one position, you are free to do it using the scroll mode setting.

Mobile support is key and content is King. Hide the banners on any device size. That is to say, extra small, small, medium and large devices. 
...
Yes, it is free and I intend to leave it free forever.

= Do you provide support? =

Yes, I do. Just go to the forums, I will answer as soon as possible

= Does the plugin rely on third party scripts? =

No. It is shipped with it's own CSS which is responsible for the position of the banners.

= What if I want a feature added? =
